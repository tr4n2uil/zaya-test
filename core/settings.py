...
DATABASES = {
    'default': {
        ...
        'NAME': 'zaya_test',                      # Or path to database file if using sqlite3.
...
DEFAULT_FROM_EMAIL = 'Sample Email <demo@zaya.org>'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'demo@zaya.org'
EMAIL_HOST_PASSWORD = 'testdemo'
EMAIL_USE_TLS = True
...
AUTH_PROFILE_MODULE = 'test.Account'
